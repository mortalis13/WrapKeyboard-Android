 ...
 * out as appropriate.
 */
public class WrapKeyboard extends InputMethodService implements
  ...
  final static int CodeSwitchLang = 55000;
...
//      System.out.println("KEYCODE_DELETE");
      ...
      if (current == mSymbolsKeyboard || current == mSymbolsShiftedKeyboard || current == mTextEditKeyboard) {
    ...
    else if (primaryCode == CodeSwitchLang) {
      Keyboard current = mInputView.getKeyboard();
...
//      ic.commitText(pasteData, 1);
  ...
  private void handleShift() {
    ...
    if (mQwertyKeyboard == currentKeyboard || mRuKeyboard == currentKeyboard) {
      // Alphabet keyboard
      // checkToggleCapsLock(); 
